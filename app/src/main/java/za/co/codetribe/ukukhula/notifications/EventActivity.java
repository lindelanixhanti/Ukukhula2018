...
import za.co.codetribe.ukukhula.ProfileActivity;
...
public class EventActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId() ) {
            case R.id.done:
                addEvent();
                Intent intent = new Intent(EventActivity.this, Eventhelper.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        select.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog dialog= new DatePickerDialog(EventActivity.this, android.R.style.Theme_Holo_Light_Dialog_MinWidth,mDateSetListener,year,month,day);
...
//        });
    ...
    private void addEvent() {
        ...
        if (!TextUtils.isEmpty(eName)) {
            ...
            Toast.makeText(EventActivity.this, "Event not saved ", Toast.LENGTH_LONG).show();
        }
        ...
        if (!TextUtils.isEmpty(eDescription)) {
            ...
            Toast.makeText(EventActivity.this, "no desc", Toast.LENGTH_LONG).show();
        }
        ...
        if (!TextUtils.isEmpty(eDate)) {
            ...
            Toast.makeText(EventActivity.this, "NO DATE", Toast.LENGTH_LONG).show();
        }
        ...
        try {
            ...
            if (val) {
                Toast.makeText(EventActivity.this, "Event saved ", Toast.LENGTH_LONG).show();
            } else {
                Toast.makeText(EventActivity.this, "Event not saved ", Toast.LENGTH_LONG).show();
            }
        }
